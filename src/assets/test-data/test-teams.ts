export const teams = [
    {
      ...
      owner: { id: '123456789', username: "coachliam", first: "Liam", last: "West", email: "liam.west@example.com" },
      managers: [
        { id: '123456788', username: "managerava", first: "Ava", last: "Tran", email: "ava.tran@example.com" }
      ],
      scorekeepers: [],
      colors: {
        home: "#1E90FF",
    ...
    },
    {
      ...
      owner: { id: '123456779', username: "ethankim", first: "Ethan", last: "Kim", email: "ethan.kim@example.com" },
      managers: [
        { id: '123456789', username: "coachliam", first: "Liam", last: "West", email: "liam.west@example.com" }
      ],
      scorekeepers: [],
      colors: {
        home: "#B22222",
    ...
    },
    {
      ...
      owner: { id: "987654321", username: "miacoach", first: "Cara", last: "Williams", email: "cara.williams@example.com" },
      managers: [
    ...
    },
    {
      ...
      owner: { id: "987654323", username: "coachjake", first: "Jake", last: "Miller", email: "jake.miller@example.com" },
      managers: [],
      scorekeepers: [],
      colors: {
        home: "#C0C0C0",
    ...
    },
    {
      ...
      owner: { id: "987654324", username: "phoenixcoach", first: "Natalie", last: "Reed", email: "natalie.reed@example.com" },
      managers: [
        { id: "987654325", username: "coachassist", first: "Grace", last: "Evans", email: "grace.evans@example.com" }
      ],
      scorekeepers: [],
      colors: {
        home: "#FFD700",
